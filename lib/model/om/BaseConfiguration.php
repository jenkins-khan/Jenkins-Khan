...
abstract class BaseConfiguration extends BaseObject  implements Persistent
{
	...
	public function setValue($v)
	{
		...
		if ($this->value !== $v) {
			$this->value = $v;
			$this->modifiedColumns[] = ConfigurationPeer::VALUE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = ConfigurationPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		$this->modifiedColumns[] = ConfigurationPeer::ID;
		if (null !== $this->id) {
			throw new PropelException('Cannot insert a value for auto-increment primary key (' . ConfigurationPeer::ID . ')');
		}
		...
		if ($this->isColumnModified(ConfigurationPeer::NAME)) {
			$modifiedColumns[':p' . $index++]  = '`NAME`';
		}
		if ($this->isColumnModified(ConfigurationPeer::VALUE)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ConfigurationPeer::VALUE)) $criteria->add(ConfigurationPeer::VALUE, $this->value);
	...
	{
		return (string) $this->exportTo(ConfigurationPeer::DEFAULT_STRING_FORMAT);
	}
	...
	public function __call($name, $params)
	{
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BaseConfiguration:' . $name))
		{
