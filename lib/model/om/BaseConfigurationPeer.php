...
abstract class BaseConfigurationPeer {
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ConfigurationPeer::NAME);
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseConfigurationPeer', $criteria, $con);
		}
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(ConfigurationPeer::ID) && $criteria->keyContainsValue(ConfigurationPeer::ID) ) {
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseConfigurationPeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
