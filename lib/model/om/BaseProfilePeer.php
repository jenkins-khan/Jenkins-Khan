...
abstract class BaseProfilePeer {
	...
	/** the column name for the JENKINS_URL field */
	const JENKINS_URL = 'profile.JENKINS_URL';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'SfGuardUserId', 'JenkinsUrl', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'sfGuardUserId', 'jenkinsUrl', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SF_GUARD_USER_ID, self::JENKINS_URL, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'SF_GUARD_USER_ID', 'JENKINS_URL', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'sf_guard_user_id', 'jenkins_url', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'SfGuardUserId' => 1, 'JenkinsUrl' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'sfGuardUserId' => 1, 'jenkinsUrl' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SF_GUARD_USER_ID => 1, self::JENKINS_URL => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'SF_GUARD_USER_ID' => 1, 'JENKINS_URL' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'sf_guard_user_id' => 1, 'jenkins_url' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ProfilePeer::JENKINS_URL);
		} else {
			$criteria->addSelectColumn($alias . '.ID');
			$criteria->addSelectColumn($alias . '.SF_GUARD_USER_ID');
			$criteria->addSelectColumn($alias . '.JENKINS_URL');
		}
	}
