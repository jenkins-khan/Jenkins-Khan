...
abstract class BasesfGuardPermissionPeer {
	...
	{
		// Invalidate objects in sfGuardGroupPermissionPeer instance pool,
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (sfGuardPermission object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = sfGuardPermissionPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = sfGuardPermissionPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + sfGuardPermissionPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = sfGuardPermissionPeer::OM_CLASS;
			$obj = new $cls();
	...
	/**
	 * Performs an INSERT on the database, given a sfGuardPermission or Criteria object.
	 *
	...
	/**
	 * Performs an UPDATE on the database, given a sfGuardPermission or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(sfGuardPermissionPeer::ID);
			if ($value) {
				$selectCriteria->add(sfGuardPermissionPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(sfGuardPermissionPeer::TABLE_NAME);
			}
	...
	/**
	 * Deletes all rows from the sf_guard_permission table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$affectedRows += BasePeer::doDeleteAll(sfGuardPermissionPeer::TABLE_NAME, $con, sfGuardPermissionPeer::DATABASE_NAME);
	...
	/**
	 * Performs a DELETE on the database, given a sfGuardPermission or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += sfGuardPermissionPeer::doOnDeleteCascade($c, $con);
