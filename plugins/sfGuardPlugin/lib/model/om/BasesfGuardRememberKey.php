...
abstract class BasesfGuardRememberKey extends BaseObject  implements Persistent
{
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 4; // 4 = sfGuardRememberKeyPeer::NUM_HYDRATE_COLUMNS.
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			$deleteQuery = sfGuardRememberKeyQuery::create()
	...
	public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
	{
		...
		$copyObj->setRememberKey($this->getRememberKey());
	...
	{
		return (string) $this->exportTo(sfGuardRememberKeyPeer::DEFAULT_STRING_FORMAT);
	}
	...
	public function __call($name, $params)
	{
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BasesfGuardRememberKey:' . $name))
		{
