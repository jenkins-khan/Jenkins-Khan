...
abstract class BasesfGuardGroupPeer {
	 ...
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 * @return     array (sfGuardGroup object, last column rank)
	 */
	public static function populateObject($row, $startcol = 0)
	{
		$key = sfGuardGroupPeer::getPrimaryKeyHashFromRow($row, $startcol);
		if (null !== ($obj = sfGuardGroupPeer::getInstanceFromPool($key))) {
			// We no longer rehydrate the object, since this can cause data loss.
			// See http://www.propelorm.org/ticket/509
			// $obj->hydrate($row, $startcol, true); // rehydrate
			$col = $startcol + sfGuardGroupPeer::NUM_HYDRATE_COLUMNS;
		} else {
			$cls = sfGuardGroupPeer::OM_CLASS;
			$obj = new $cls();
	...
	/**
	 * Performs an INSERT on the database, given a sfGuardGroup or Criteria object.
	 *
	...
	/**
	 * Performs an UPDATE on the database, given a sfGuardGroup or Criteria object.
	 *
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$value = $criteria->remove(sfGuardGroupPeer::ID);
			if ($value) {
				$selectCriteria->add(sfGuardGroupPeer::ID, $value, $comparison);
			} else {
				$selectCriteria->setPrimaryTableName(sfGuardGroupPeer::TABLE_NAME);
			}
	...
	/**
	 * Deletes all rows from the sf_guard_group table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			$affectedRows += BasePeer::doDeleteAll(sfGuardGroupPeer::TABLE_NAME, $con, sfGuardGroupPeer::DATABASE_NAME);
	...
	/**
	 * Performs a DELETE on the database, given a sfGuardGroup or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += sfGuardGroupPeer::doOnDeleteCascade($c, $con);
